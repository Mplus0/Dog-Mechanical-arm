...
from red_block_grasp_mplus0.core.camera_rgbd_orbbec import OrbbecRgbdCamera
from red_block_grasp_mplus0.core.color_red_block_detector import RedColorBlockDetector
from red_block_grasp_mplus0.core.target_localizer import TargetLocalizer
from red_block_grasp_mplus0.core.yolo_detector import YoloRedBlockDetector


class TargetLocalizerNode(Node):
    def __init__(self):
        super().__init__("target_localizer_node")
        package_share = get_package_share_directory("red_block_grasp_mplus0")

        self.declare_parameter(
            "model_path",
            os.path.join(package_share, "models", "red_block_yolo11n.pt"),
        )
        self.declare_parameter(
            "handeye_path",
            os.path.join(package_share, "handeye", "handeye_cam_to_eef.json"),
        )
        ...
        self.declare_parameter(
            "hard_sample_dir",
            os.path.expanduser("~/.ros/red_block_grasp_mplus0/hard_samples"),
        )
